...
ResourceManager::ResourceManager()
{
    ...
    createInstance({"VK_LAYER_KHRONOS_validation"}, {VK_KHR_PORTABILITY_ENUMERATION_EXTENSION_NAME, "VK_MVK_macos_surface", VK_EXT_DEBUG_UTILS_EXTENSION_NAME});
}
...
void ResourceManager::remove(ResourceType type, const std::string &name)
{
