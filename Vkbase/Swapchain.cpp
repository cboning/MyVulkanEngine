...
// namespace Vkbase
// {
//     Swapchain::Swapchain(const std::string& resourceName, vk::Device device, vk::SurfaceKHR surface, uint32_t width, uint32_t height)
//         : ResourceBase(resourceName, ResourceType::Window), _device(device), _surface(surface), _width(width), _height(height)
//     {
//         init();
//     }
