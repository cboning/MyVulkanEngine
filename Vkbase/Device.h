...
class Device : public ResourceBase
{
  ...
  public:
    struct QueueFamilyIndices
    {
        ...
        bool isComplete() const { return graphicsFamilyIndex >= 0 && presentFamilyIndex >= 0 && computeFamilyIndex >= 0; }

        bool operator==(const QueueFamilyIndices &right) const
        {
            return graphicsFamilyIndex == right.graphicsFamilyIndex && computeFamilyIndex == right.computeFamilyIndex &&
