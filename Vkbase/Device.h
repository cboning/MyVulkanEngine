...
class Device : public ResourceBase {
 public:
  struct QueueFamilyIndices {
    ...
    bool operator==(const QueueFamilyIndices &right) const {
      return graphicsFamilyIndex == right.graphicsFamilyIndex &&
             computeFamilyIndex == right.computeFamilyIndex &&
             presentFamilyIndex == right.presentFamilyIndex;
    }
  };
  ...
  static SurfaceSupportDetails querySwapChainSupport(
  ...
  vk::Format findSupportedFormat(std::vector<vk::Format> formats,
                                 vk::ImageTiling tiling,
                                 vk::FormatFeatureFlags feature) const;
 ...
 private:
  ...
  static bool isPhysicalDeviceSuitable(const vk::PhysicalDevice &device,
                                       const vk::SurfaceKHR &surface);
  static bool checkSwapChainSupport(const vk::PhysicalDevice &device,
                                    const vk::SurfaceKHR &surface);
