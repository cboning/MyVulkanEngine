...
std::string JsonConfigReader::getJsonWithFormat(const vk::Format &format)
{

    static const std::unordered_map<vk::Format, std::string> formatMap = {
        ...
        {vk::Format::eE5B9G9R9UfloatPack32, "E5B9G9R9UfloatPack32"},
        ...
        {vk::Format::eEtc2R8G8B8UnormBlock, "Etc2R8G8B8UnormBlock"},
        {vk::Format::eEtc2R8G8B8SrgbBlock, "Etc2R8G8B8SrgbBlock"},
        {vk::Format::eEtc2R8G8B8A1UnormBlock, "Etc2R8G8B8A1UnormBlock"},
        {vk::Format::eEtc2R8G8B8A1SrgbBlock, "Etc2R8G8B8A1SrgbBlock"},
        {vk::Format::eEtc2R8G8B8A8UnormBlock, "Etc2R8G8B8A8UnormBlock"},
        {vk::Format::eEtc2R8G8B8A8SrgbBlock, "Etc2R8G8B8A8SrgbBlock"},
        {vk::Format::eEacR11UnormBlock, "EacR11UnormBlock"},
        {vk::Format::eEacR11SnormBlock, "EacR11SnormBlock"},
        {vk::Format::eEacR11G11UnormBlock, "EacR11G11UnormBlock"},
        {vk::Format::eEacR11G11SnormBlock, "EacR11G11SnormBlock"},
        ...
        {vk::Format::eG8B8R82Plane444Unorm, "G8B8R82Plane444Unorm"},
        {vk::Format::eG8B8R82Plane444UnormEXT, "G8B8R82Plane444UnormEXT"},
        {vk::Format::eG10X6B10X6R10X62Plane444Unorm3Pack16, "G10X6B10X6R10X62Plane444Unorm3Pack16"},
        {vk::Format::eG10X6B10X6R10X62Plane444Unorm3Pack16EXT, "G10X6B10X6R10X62Plane444Unorm3Pack16EXT"},
        {vk::Format::eG12X4B12X4R12X42Plane444Unorm3Pack16, "G12X4B12X4R12X42Plane444Unorm3Pack16"},
        {vk::Format::eG12X4B12X4R12X42Plane444Unorm3Pack16EXT, "G12X4B12X4R12X42Plane444Unorm3Pack16EXT"},
        {vk::Format::eG16B16R162Plane444Unorm, "G16B16R162Plane444Unorm"},
        {vk::Format::eG16B16R162Plane444UnormEXT, "G16B16R162Plane444UnormEXT"},
        {vk::Format::eA4R4G4B4UnormPack16, "A4R4G4B4UnormPack16"},
        {vk::Format::eA4R4G4B4UnormPack16EXT, "A4R4G4B4UnormPack16EXT"},
        {vk::Format::eA4B4G4R4UnormPack16, "A4B4G4R4UnormPack16"},
        {vk::Format::eA4B4G4R4UnormPack16EXT, "A4B4G4R4UnormPack16EXT"},
        {vk::Format::eAstc4x4SfloatBlock, "Astc4x4SfloatBlock"},
        {vk::Format::eAstc4x4SfloatBlockEXT, "Astc4x4SfloatBlockEXT"},
        {vk::Format::eAstc5x4SfloatBlock, "Astc5x4SfloatBlock"},
        {vk::Format::eAstc5x4SfloatBlockEXT, "Astc5x4SfloatBlockEXT"},
        {vk::Format::eAstc5x5SfloatBlock, "Astc5x5SfloatBlock"},
        {vk::Format::eAstc5x5SfloatBlockEXT, "Astc5x5SfloatBlockEXT"},
        {vk::Format::eAstc6x5SfloatBlock, "Astc6x5SfloatBlock"},
        {vk::Format::eAstc6x5SfloatBlockEXT, "Astc6x5SfloatBlockEXT"},
        {vk::Format::eAstc6x6SfloatBlock, "Astc6x6SfloatBlock"},
        {vk::Format::eAstc6x6SfloatBlockEXT, "Astc6x6SfloatBlockEXT"},
        {vk::Format::eAstc8x5SfloatBlock, "Astc8x5SfloatBlock"},
        {vk::Format::eAstc8x5SfloatBlockEXT, "Astc8x5SfloatBlockEXT"},
        {vk::Format::eAstc8x6SfloatBlock, "Astc8x6SfloatBlock"},
        {vk::Format::eAstc8x6SfloatBlockEXT, "Astc8x6SfloatBlockEXT"},
        {vk::Format::eAstc8x8SfloatBlock, "Astc8x8SfloatBlock"},
        {vk::Format::eAstc8x8SfloatBlockEXT, "Astc8x8SfloatBlockEXT"},
        {vk::Format::eAstc10x5SfloatBlock, "Astc10x5SfloatBlock"},
        {vk::Format::eAstc10x5SfloatBlockEXT, "Astc10x5SfloatBlockEXT"},
        {vk::Format::eAstc10x6SfloatBlock, "Astc10x6SfloatBlock"},
        {vk::Format::eAstc10x6SfloatBlockEXT, "Astc10x6SfloatBlockEXT"},
        {vk::Format::eAstc10x8SfloatBlock, "Astc10x8SfloatBlock"},
        {vk::Format::eAstc10x8SfloatBlockEXT, "Astc10x8SfloatBlockEXT"},
        {vk::Format::eAstc10x10SfloatBlock, "Astc10x10SfloatBlock"},
        {vk::Format::eAstc10x10SfloatBlockEXT, "Astc10x10SfloatBlockEXT"},
        {vk::Format::eAstc12x10SfloatBlock, "Astc12x10SfloatBlock"},
        {vk::Format::eAstc12x10SfloatBlockEXT, "Astc12x10SfloatBlockEXT"},
        {vk::Format::eAstc12x12SfloatBlock, "Astc12x12SfloatBlock"},
        {vk::Format::eAstc12x12SfloatBlockEXT, "Astc12x12SfloatBlockEXT"},
        {vk::Format::eA1B5G5R5UnormPack16, "A1B5G5R5UnormPack16"},
        {vk::Format::eA1B5G5R5UnormPack16KHR, "A1B5G5R5UnormPack16KHR"},
        {vk::Format::eA8Unorm, "A8Unorm"},
        {vk::Format::eA8UnormKHR, "A8UnormKHR"},
        ...
        {vk::Format::eR8BoolARM, "R8BoolARM"},
        {vk::Format::eR16G16Sfixed5NV, "R16G16Sfixed5NV"},
        {vk::Format::eR16G16S105NV, "R16G16S105NV"},
        {vk::Format::eR10X6UintPack16ARM, "R10X6UintPack16ARM"},
        {vk::Format::eR10X6G10X6Uint2Pack16ARM, "R10X6G10X6Uint2Pack16ARM"},
        {vk::Format::eR10X6G10X6B10X6A10X6Uint4Pack16ARM, "R10X6G10X6B10X6A10X6Uint4Pack16ARM"},
        {vk::Format::eR12X4UintPack16ARM, "R12X4UintPack16ARM"},
        {vk::Format::eR12X4G12X4Uint2Pack16ARM, "R12X4G12X4Uint2Pack16ARM"},
        {vk::Format::eR12X4G12X4B12X4A12X4Uint4Pack16ARM, "R12X4G12X4B12X4A12X4Uint4Pack16ARM"},
        {vk::Format::eR14X2UintPack16ARM, "R14X2UintPack16ARM"},
        {vk::Format::eR14X2G14X2Uint2Pack16ARM, "R14X2G14X2Uint2Pack16ARM"},
        {vk::Format::eR14X2G14X2B14X2A14X2Uint4Pack16ARM, "R14X2G14X2B14X2A14X2Uint4Pack16ARM"},
        {vk::Format::eR14X2UnormPack16ARM, "R14X2UnormPack16ARM"},
        {vk::Format::eR14X2G14X2Unorm2Pack16ARM, "R14X2G14X2Unorm2Pack16ARM"},
        {vk::Format::eR14X2G14X2B14X2A14X2Unorm4Pack16ARM, "R14X2G14X2B14X2A14X2Unorm4Pack16ARM"},
        {vk::Format::eG14X2B14X2R14X22Plane420Unorm3Pack16ARM, "G14X2B14X2R14X22Plane420Unorm3Pack16ARM"},
        {vk::Format::eG14X2B14X2R14X22Plane422Unorm3Pack16ARM, "G14X2B14X2R14X22Plane422Unorm3Pack16ARM"}};
    auto it = formatMap.find(format);
    if (it != formatMap.end())
        return it->second;
    else
        throw std::invalid_argument("Unknown PipelineStageFlagBit: " + std::to_string(static_cast<uint32_t>(format)));
}
...
std::vector<vk::AttachmentDescription> JsonConfigReader::getAttachmentsWithJson(const json &config, vk::Format depthFormat)
{
    ...
    for (uint32_t i = 0; i < attachments.size(); ++i)
    {
        ...
        attachment
            .setFormat(getFormatWithJson(attachmentJson["format"], attachmentJson.count("swapchainName") ? attachmentJson["swapchainName"] : "", depthFormat))
