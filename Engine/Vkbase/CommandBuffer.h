...
private:
    ...
    std::unordered_set<VkResourceManagerHolder::WeakReference> _secondaryCommandBuffers;
    bool _primary;
...
public:
    ...
    void beginRenderPass(const VkResourceManagerHolder::WeakReference &renderPass, const VkResourceManagerHolder::WeakReference &framebuffer,
